...
with tab1:
    ...
    # 버전 정보 (작곡가 포함)
    version_info = {
        "버전 1": {"composer": "김동진 작곡 (1954)", "style": "클래식 가곡"},
        "버전 2": {"composer": "김달성 작곡", "style": "현대 예술가곡"},
        "버전 3": {"composer": "김순남 작곡 (1940년대)", "style": "민족주의 노선"},
        "버전 4": {"composer": "윤학준 작곡", "style": "합창곡"},
        "버전 5": {"composer": "김진표 작곡, 노바소닉 (1999)", "style": "뉴메탈"},
        "버전 6": {"composer": "우지민 작곡, 마야 (2003)", "style": "록 발라드"},
        "버전 7": {"composer": "윤상 작곡, 정훈희 (2002)", "style": "세련된 발라드"}
    }
